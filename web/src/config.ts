/**
 * Runtime endpoint resolution for fulfillment_mfe.
 *
...
const API_PATH = "/api/fulfillment-execution";
const DEV_API_BASE = "http://localhost:8084";

export function resolveFulfillmentApiBase(
...
export const FULFILLMENT_API_BASE = resolveFulfillmentApiBase(
