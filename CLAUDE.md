...
- ADRs: `docs/docs/adr/0001` through `0026` (latest: 0025 `TaskCPTMissed`
  sweep + `PackageManifested` on the outbox; 0026 on-time-to-CPT KPI on the
  throughput data product) — read the index at `docs/docs/adr/index.md`
  before assuming a decision is undocumented. ADR-0022 removed REST/MCP auth
  and supersedes ADR-0021.
