...
| [0021](./0021-rest-identity-static-bearer-scopes.md) | Adopt the fleet REST identity — static bearer keys with read/read-write scopes, `AUTH_MODE` rollout gate | Superseded by [ADR-0022](./0022-remove-rest-mcp-auth.md) |
